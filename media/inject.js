...
(function () {
	...
	// `name -> colors` map, plus that workspace's own selection options. Two signals
	...
	function activeContext(view) {
		...
		return { repos: merged, selection: sel || config.selection };
	}
	...
	function paint(root) {
		...
		var REPOS = context.repos;         // name -> colors
